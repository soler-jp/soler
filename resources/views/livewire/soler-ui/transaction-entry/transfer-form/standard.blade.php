<div>
    <x-ui.card collapsible>
        <x-ui.card-header toggle>
            {{ __('transactions.transfer_form.title') }}
        </x-ui.card-header>
        ...
        <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2">
                @foreach ($this->fromOptions as $option)
                    <button type="button"
        ...
        <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2">
                @foreach ($this->toOptions as $option)
                    <button type="button"
        ...
        <div class="pt-1">
            <x-ui.button variant="confirm" type="button" wire:click="submit" class="w-full">
                {{ __('transactions.transfer_form.actions.submit') }}
            </x-ui.button>
        </div>
        </div>
    </x-ui.card>
