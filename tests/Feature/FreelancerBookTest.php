    ...
    public function 青色申告用の取引サンプルを8件登録できる()
    {
        ...
        $samples = [
            [
                ...
                'credit' => ['bank', 5500, 0, 'out_of_scope'],
            ],
            [
                'date' => '2024-01-10',
                'description' => '売上入金（ココナラ）',
                'debit' => ['bank', 11000, 0, 'out_of_scope'],
            ...
            [
                ...
                'credit' => ['bank', 3300, 0, 'out_of_scope'],
            ],
            [
                'date' => '2024-01-25',
                'description' => '電車代',
                'debit' => ['transport', 1500, 0, 'out_of_scope'],
                'credit' => ['cash', 1500, 0, 'out_of_scope'],
            ],
            [
                'date' => '2024-02-01',
                'description' => '2月家賃支払',
                'debit' => ['rent', 54545, 5455, 'taxable_purchases_10'],
                'credit' => ['bank', 60000, 0, 'out_of_scope'],
            ],
            [
                'date' => '2024-02-07',
                'description' => '売上入金（直接振込）',
                'debit' => ['bank', 55000, 0, 'out_of_scope'],
            ...
            [
                ...
                'credit' => ['cash', 800, 0, 'out_of_scope'],
            ],
            [
                'date' => '2024-02-25',
                'description' => 'ソフト購入（Adobe）',
                'debit' => ['books', 2980, 298, 'taxable_purchases_10'],
                'credit' => ['owner_contribution', 3278, 0, 'out_of_scope'],
            ],
        ];
